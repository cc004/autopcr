...
CHARA_NAME = {
    ...
    1008: ["雪", "ユキ", "Yuki", "小雪", "镜子", "镜法", "伪娘", "男孩子", "男孩纸", "雪哥", '普雪'],
    ...
    1042: ["千歌", "チカ", "Chika", "绿毛奶", "精灵奶", '普千'],
    1043: ["真琴", "マコト", "Makoto", "狼", "🐺", "月月", "朋", "狼姐", '普狼'],
    ...
    1056: ["流夏", "ルカ", "Ruka", "大姐", "大姐头", "儿力", "luka", "刘夏", "露卡", "卢卡", '普流'],
    ...
    1061: ["矛依未", "ムイミ", "Muimi", "诺维姆", "Noemu", "夏娜", "511", '矛衣未', "无意义", "天楼霸断剑", "姆咪", "母咪"],

    1063: ["亚里莎", "アリサ", "Arisa", "鸭梨瞎", "瞎子", "亚里沙", "鸭梨傻", "亚丽莎", "亚莉莎", "瞎子弓", "🍐🦐", "yls"],
    1064: ["雪菲", "シェフィ", "Shephy", "Shefi", "紫布菜", "冰龙", '普雪菲'],
    ...
    1070: ["似似花", "ネネカ", "Neneka", "变貌大妃", "现士实似似花", "現士実似々花", "現士実", "现士实", "n", "N", "nnk", "448", "捏捏卡", "变貌", "大妃", "奶奶卡"],
    ...
    1084: ["千歌(圣诞节)", "チカ(クリスマス)", "Chika(Xmas)", "圣诞千歌", "圣千", "千", "蛋鸽", "🎄💰🎶", "🎄千🎶", "🎄1000🎶"],
    ...
    1110: ["优妮", "ユニ", "Yuni", "真行寺由仁", "由仁", "优尼", "u2", "优妮辈先", "辈先", "书记", "uni", "先辈", "仙贝", "油腻", "优妮先辈", "学姐", "18岁黑丝学姐", "咖啡人", '小优妮'],
    ...
    1158: ["莉玛(灰姑娘)", "リマ(シンデレラ)", "Rima(Cinderella)", "人形羊驼", "人驼", "灰驼", "灰羊驼", "灰姑娘羊驼", "灰羊"],
    1159: ["真琴(灰姑娘)", "マコト(シンデレラ)", "Makoto(Cinderella)", "灰姑娘狼", "灰狼", '大灰狼'],
    1160: ["真步(灰姑娘)", "マホ(シンデレラ)", "Maho(Cinderella)", "灰姑娘狐狸", "灰真步","灰狐狸", "灰狐", "灰壶", "茶狐", "茶壶"],

    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(Seigakusai)", "克罗依(圣学祭)", "运动华", "运动华哥", "圣学祭华", "圣学祭克萝依", "圣华", "克洛伊(圣学祭)"],
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "千爱瑠(圣学祭)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣学祭千爱瑠", "圣爱瑠", '圣切'],
    1164: ["优妮(圣学祭)", "ユニ(聖学祭)", "Yuni(Seigakusai)", "圣优妮", "圣uni", '大un', "运动优妮", "运动服", "罗塞塔", '大优妮'],
    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八", '时空龙锤', '时锤'],
    1166: ["嘉夜(时间旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "时间旅行龙拳", "穿越龙拳", "水手龙", "水手龙拳", "时空龙拳"],
    1167: ["碧(作业服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "碧(工作服)", "工菜", "韭菜", "工作碧", "贡菜", "香菜弓(工作服)"],
    1168: ["珠希(作业服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "珠希(工作服)", '工猫', "工猫贼", "工猫剑", "工贼", "工珠希", "猫剑(工作服)"],
    ...
    1177: ["香织(万圣节)", "カオリ(ハロウィン)", "Kaori(Halloween)", "万圣狗", "瓜狗", "万圣狗拳", '鬼狗'],
    1178: ["妮诺(万圣节)", "ニノン(ハロウィン)", "Ninon(Halloween)", "妮侬(万圣节)", "万圣扇", "瓜扇", "万圣扇子", '鬼扇'],
    ...
    1191: ["空花(黑暗)", "クウカ(ノワール)", "Kuuka(Noir)", "黑m", "暗m", "黑M"],
    1192: ["真阳(圣诞节)", "マヒル(クリスマス)", "Mahiru(Xmas)", "圣牛", "蛋牛", "圣诞奶牛", "圣诞牛", "圣诞真阳"],
    ...
    1208: ["流夏(新年)", "ルカ(ニューイヤー)", "Ruka(NewYear)", "春流夏", "春流", "新年流夏"],
    1209: ["伊莉亚(新年)", "イリヤ(ニューイヤー)", "Iriya(NewYear)", "新年伊莉亚", "新年伊利亚", "新年伊莉雅", "新年伊利雅", "新年yly", "新年吸血鬼", "春伊", "春yly", "伊莉旦"],
    1210: ["贪吃佩可(超载)", "ペコリーヌ(オーバーロード)", "Pecorine(Overload)", "Pekoriinu(Overload)", "佩可莉姆(超负荷)", "超载吃", "超吃", "超载佩可", "超载佩", "超佩", "佩可(超载)"],
    1211: ["凯留(超载)", "キャル(オーバーロード)", "Karyl(Overload)", "凯露(超载)", "Kyaru(Overload)", "凯露(超负荷)", "超载凯留", "超凯留", "超载黑猫", "超黑", "超猫", "超威蓝猫"],
    1212: ["拉比林斯达(超载)", "ラビリスタ(オーバーロード)", "Labyrista(Overload)", "Rabirisuta(Overload)", "菈比莉斯塔(超负荷)", "超载晶", "超晶", "晶(超载)"],
    ...
    1216: ["祈梨(怪盗)", "イノリ(怪盗)", "Inori(Kaitou)", "怪盗祈梨", "怪盗龙锤", "忍龙", "忍龙锤", '盗锤'],
    1217: ["秋乃(秋乃&咲恋)", "アキノ(アキノ&サレン)", "Akino(Akino&Saren)"],
    1218: ["咲恋(秋乃&咲恋)", "サレン(アキノ&サレン)", "Saren(Akino&Saren)"],
    1219: ["杏奈(海盗)", "アンナ(パイレーツ)", "Anna(Pirates)", "海盗中二", "海二", "海盗杏奈", "船长中二", "船二"],
    1220: ["忍(海盗)", "シノブ(パイレーツ)", "Shinobu(Pirates)", "海盗忍", "海贼忍", "海忍", "水手忍", "手忍"],
    1221: ["碧(露营)", "アオイ(キャンプ)", "Aoi(Camp)", "露营碧", "露碧", "野菜"],
    1222: ["优花梨(露营)", "ユカリ(キャンプ)", "Yukari(Camp)", "由加莉(露营)", "露营优花梨", "露优花梨", "露花梨", "露营黄骑", "露黄骑", "露黄", '露骑'],
    1223: ["斑比", "ヴァンピィ", "Vampy", "Vania", "斑比酱", "钉宫"],
    1224: ["日和(夏日)", "ヒヨリ(サマー)", "Hiyori(Summer)", "日和莉(夏日)", "水猫拳", "水日和"],
    1225: ["怜(夏日)", "レイ(サマー)", "Rei(Summer)", "水怜", "水剑圣", '水剑'],
    1226: ["优衣(夏日)", "ユイ(サマー)", "Yui(Summer)", "水优衣", "水ue", "水田", "泳衣", "游依", "水草", '水衣'],
    ...
    1232: ["绫音(探险家)", "アヤネ(エクスプローラー)", "Ayane(Explorer)", "野锤", "野炊", "探锤"],
    1233: ["涅娅", "ネア", "Nea", "小黄", "史莱姆", "黄史莱姆"],

    1235: ["铃(万圣节)", "リン(ハロウィン)", "Rin(Halloween)", "瓜松鼠", "鬼松鼠", "万圣松鼠"],
    1236: ["智(万圣节)", "トモ(ハロウィン)", "Tomo(Halloween)", "瓜智", "鬼智", "万圣智", '警智'],
    ...
    1240: ["茜里(圣诞节)", "アカリ(クリスマス)", "Akari(Xmas)", "圣妹", "圣诞妹法", "圣茜里"],
    1241: ["依里(圣诞节)", "ヨリ(クリスマス)", "Yori(Xmas)", "圣姐", "圣诞姐法", "圣伊里"],
    ...
    1808: ["禊&美美&镜华", "ミソギ&ミミ&キョウカ", "Misogi&Mimi&Kyouka", "小小甜心", "狱三家", "小御三家", 'xxtx'],
