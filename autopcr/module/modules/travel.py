...
@TravelQuestConfig("travel_target_quest3", "轮转队伍3", [11002002, 11002003, 11002005])
@TravelQuestConfig("travel_target_quest2", "轮转队伍2", [11002004])
@TravelQuestConfig("travel_target_quest1", "轮转队伍1", [11002001])
@name('探险轮转')
@description('''
